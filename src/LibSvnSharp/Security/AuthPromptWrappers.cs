...
{
    internal sealed unsafe class AuthPromptWrappers : IDisposable
    {
        ...
        private static unsafe IntPtr _svn_auth_username_prompt_func(
            /*out svn_auth_cred_username_t*/ IntPtr* credPtr, IntPtr baton, sbyte* realm, int maySave, /*apr_pool_t*/ IntPtr pool)
        {
        ...
        private static unsafe IntPtr _svn_auth_simple_prompt_func(
            /*out svn_auth_cred_simple_t*/ IntPtr* credPtr, IntPtr baton, sbyte* realm, sbyte* username, int maySave, /*apr_pool_t*/ IntPtr pool)
        {
        ...
        private static unsafe IntPtr _svn_auth_ssl_server_trust_prompt_func(
            /*out svn_auth_cred_ssl_server_trust_t*/ IntPtr* ppCred, IntPtr baton, sbyte* realm, uint failures, /*svn_auth_ssl_server_cert_info_t*/ IntPtr certInfo, int maySave, /*apr_pool_t*/ IntPtr pool)
        {
        ...
        private static unsafe IntPtr _svn_auth_ssl_client_cert_prompt_func(
            /*out svn_auth_cred_ssl_client_cert_t*/ IntPtr* credPtr, IntPtr baton, sbyte* realm, int maySave, /*apr_pool_t*/ IntPtr pool)
        {
        ...
        private static unsafe IntPtr _libsvnsharp_auth_plaintext_prompt(int* maySavePlaintext, sbyte* realmString, IntPtr baton, IntPtr pool)
        {
            *maySavePlaintext = 1;
            return IntPtr.Zero;
        }
