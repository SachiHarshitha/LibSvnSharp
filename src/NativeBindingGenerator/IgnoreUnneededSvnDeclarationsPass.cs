...
{
    internal sealed class IgnoreUnneededSvnDeclarationsPass : TranslationUnitPass
    {
        private const string _moduleName = "SvnUnmanagedApi";
        ...
        private static Dictionary<string, IList<string>> _declaredFunctions = new Dictionary<string, IList<string>>
        {
            {
                "svn_auth",
                new[]
        ...
        private static IList<string> _declaredStructs = new[]
        {
            "svn_log_entry_t",
            "svn_error_t",
            "svn_sort__item_t",
        ...
        private static IList<string> _declaredEnums = new[]
        {
        ...
        private static IList<string> _declaredDelegates = new[]
        {
